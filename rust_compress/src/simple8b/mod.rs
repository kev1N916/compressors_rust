...
pub(crate) struct DecodeResult {
    decoded_result: Vec<u64>,
}

pub struct Simple8b {}

impl Simple8b {
    pub fn encode(list: Vec<u64>) -> EncodeResult {
                ...
                match selector_idx {
                    ...
                    _ => {
                        ...
                        while idx < n {
                            ...
                            if no_of_items == selector.group_size || list[idx] > ((1u64 << selector.item_width) - 1) as u64 {
                                break;
                            }
    ...
    pub fn decode(list: Vec<u64>) -> DecodeResult {
...
mod tests {
    ...
    fn test_encode_decode_roundtrip_small() {
        ...
        let encoded = Simple8b::encode(original.clone());
        let encoded_u64 = bytes_to_u64_vec(&encoded.encoded_result);
        let decoded = Simple8b::decode(encoded_u64);
    ...
    fn test_encode_decode_roundtrip_empty() {
        ...
        assert_eq!(encoded.encoded_result.len(), 0);
    }
    ...
    fn test_encode_decode_8_bit_values() {
        ...
        let original = vec![0, 100, 200, 255, 128, 64];
        let encoded = Simple8b::encode(original.clone());
        let encoded_u64 = bytes_to_u64_vec(&encoded.encoded_result);
        let decoded = Simple8b::decode(encoded_u64);
    ...
    fn test_encode_decode_large_random_pattern() {
        ...
        let encoded = Simple8b::encode(extended.clone());
        let encoded_u64 = bytes_to_u64_vec(&encoded.encoded_result);
        let decoded = Simple8b::decode(encoded_u64);

        assert_eq!(&decoded.decoded_result[..extended.len()], &extended[..]);
    }
}
